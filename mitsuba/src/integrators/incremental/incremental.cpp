...
class IncrementalIntegrator : public MonteCarloIntegrator {
public:
    IncrementalIntegrator(const Properties &props) : MonteCarloIntegrator(props) {
    ...
    */
    ...
    std::string toString() const {
        ...
        oss << "IncrementalIntegrator[" << endl
 ...
 * 
 */
MTS_IMPLEMENT_CLASS_S(IncrementalIntegrator, false, MonteCarloIntegrator)
